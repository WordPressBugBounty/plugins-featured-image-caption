...
class MetaBox {
    ...
    public function save_metabox($post_id)
    {
        ...
        */
        ...
        $caption = array(
            'caption_text'    => wp_kses($_POST[CCFIC_KEY.'_caption_text'], $allowed_html),
            'source_text'    => wp_kses($_POST[CCFIC_KEY.'_source_text'], $allowed_html),
            'source_url'    => esc_url_raw($_POST[CCFIC_KEY.'_source_url']),
